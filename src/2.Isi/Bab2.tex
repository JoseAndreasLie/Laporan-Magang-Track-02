...
Struktur organisasi perusahaan PT Visi Karya Nusantara dapat dilihat pada Gambar \ref{fig:struktur_organisasi}.
% \begin{figure}
% 	\centering
% 	\fbox{\includegraphics[width=0.8\textwidth]{assets/pics/fig_struktur_organisasi.jpg}}
% 	\caption{Struktur organisasi perusahaan PT Visi Karya Nusantara \cite{newemployeeonboarding2025}}
% 	\vspace{0em}
